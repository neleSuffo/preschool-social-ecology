...
class Research_QuestionConfig:
    ...
    MAX_GAP_DURATION_SEC = 5
    MIN_INTERACTION_DURATION_SEC = 5
    MIN_ALONE_DURATION_SEC = 5
    MIN_VOICE_DURATION_SEC = 3
    MAX_VOICE_GAP_SEC = 2
    MIN_KCHI_VOCALIZATION_DURATION_SEC = 1
    MAX_KCHI_VOCALIZATION_GAP_SEC = 0.5